...
namespace DXApp24.Blazor.Server.Templates;
public class CustomPopupWindowTemplate : WindowTemplateBase, ISupportActionsToolbarVisibility, IPopupWindowTemplateSize {
    public CustomPopupWindowTemplate() {
    ...
    protected override RenderFragment CreateComponent() => CustomPopupWindowTemplateComponent.Create(this);
